package com.amikel.maxi.repositorioimage.config;
...
import com.amikel.maxi.repositorioimage.config.filter.JwtFilter;
...
public class SecurityConfig {
    ...
    @Bean
    public JwtFilter jwtFilter(JwtService jwtService, UserServiceImpl userService){
